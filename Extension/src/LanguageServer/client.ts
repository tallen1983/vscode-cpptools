...
export function createClient(workspace: Workspace): Client {
    return new DefaultClient(workspace);
}
            ...
            errorHandler: {
                ...
                closed: () => {
                        ...
                        if (this.crashTimes.length < 5) {
                            let newClient: DefaultClient = <DefaultClient>workspace.replace(this, true);
